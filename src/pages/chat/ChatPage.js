 ...
 * @Date:   2017-11-18T14:30:00+08:00
...
export default class ChatPage extends React.Component {
  ...
  componentWillMount() {
    ...
    this.setState(() => {
      return {
        messages: require('./src/data/messages.js'),
      };
    });
  }
  ...
  onLoadEarlier() {
    ...
    setTimeout(() => {
      if (this._isMounted === true) {
        this.setState((previousState) => {
          return {
            messages: GiftedChat.prepend(previousState.messages, require('./src/data/old_messages.js')),
            loadEarlier: false,
            isLoadingEarlier: false,
          };
        });
